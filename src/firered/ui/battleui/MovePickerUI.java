...
public class MovePickerUI {
	...
	public void init(Pokemon pokemon) {
		...
		this.ppText = new Text(pokemon.moves[0].maxPP + "/" + pokemon.moves[0].maxPP, MyFont.BATTLE_UI_FONT_LIGHT);
	...
	public void tick(double delta) {
		...
		ppText = new Text(selectedMove.maxPP + "/" + selectedMove.maxPP, MyFont.BATTLE_UI_FONT_LIGHT);
		ppText.setPosition(231 - ppText.getPixelWidth(), 123);
	...
	public Move getMove(Pokemon pokemon) {
		int selectArrowX = optionLeft ? 0 : 1; 
		int selectArrowY = optionUp ? 0 : 2;
		optionLeft = optionUp = true;
		return pokemon.moves[selectArrowX + selectArrowY];
	}
}